...
* [tinytag](https://github.com/devsnd/tinytag) ⭐ 835 | 🐛 6 | 🌐 Python | 📅 2026-09-03 [:octocat:](https://github.com/devsnd/tinytag) ⭐ 835 | 🐛 6 | 🌐 Python | 📅 2026-09-03 [:package:](https://pypi.python.org/pypi/tinytag/) - reading music meta data of MP3, OGG, FLAC and Wave files.
...
* [PyWavelets](http://pywavelets.readthedocs.io) [:octocat:](https://github.com/PyWavelets/pywt) ⭐ 2,399 | 🐛 83 | 🌐 Python | 📅 2026-09-02 [:package:](https://pypi.python.org/pypi/PyWavelets) - Discrete Wavelet Transform in Python.
...
* [essentia](http://essentia.upf.edu) [:octocat:](https://github.com/MTG/essentia) ⭐ 3,711 | 🐛 435 | 🌐 C++ | 📅 2026-08-27 - Music related low level and high level feature extractor, C++ based, includes Python bindings.
...
* [pyannote.audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,505 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2026-09-02 [:octocat:](https://github.com/pyannote/pyannote-audio) ⭐ 10,505 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2026-09-02 [:package:](https://pypi.org/project/pyannote-audio/) - Neural building blocks for speaker diarization.
...
* [Brian2](http://briansimulator.org/) [:octocat:](https://github.com/brian-team/brian2) ⭐ 1,224 | 🐛 206 | 🌐 Python | 📅 2026-09-03 [:package:](https://pypi.python.org/pypi/Brian2) - Spiking neural networks simulator, includes cochlea model.
...
* [librosa](http://librosa.github.io/librosa/) [:octocat:](https://github.com/librosa/librosa) ⭐ 8,583 | 🐛 51 | 🌐 Python | 📅 2026-08-22 [:package:](https://pypi.python.org/pypi/librosa) - General audio and music analysis.
* [Madmom](https://madmom.readthedocs.io/en/latest/) [:octocat:](https://github.com/CPJKU/madmom) ⭐ 1,706 | 🐛 81 | 🌐 Python | 📅 2026-03-20 [:package:](https://pypi.python.org/pypi/madmom) - MIR packages with strong focus on beat detection, onset detection and chord recognition.
...
* [TorchAudio](https://github.com/pytorch/audio) ⭐ 2,934 | 🐛 339 | 🌐 Python | 📅 2026-09-03 [:octocat:](https://github.com/pytorch/audio) ⭐ 2,934 | 🐛 339 | 🌐 Python | 📅 2026-09-03 - PyTorch Audio Loaders
...
* [Youtube-Downloader](http://rg3.github.io/youtube-dl/) [:octocat:](https://github.com/rg3/youtube-dl) ⭐ 141,091 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 [:package:](https://pypi.python.org/pypi/youtube_dl) - Download youtube videos (and the audio).
* [beets](http://beets.io/) [:octocat:](https://github.com/beetbox/beets) ⭐ 15,612 | 🐛 715 | 🌐 Python | 📅 2026-09-03 [:package:](https://pypi.python.org/pypi/beets) - Music library manager and [MusicBrainz](https://musicbrainz.org/) tagger.
...
* [Python Data Science Handbook](https://github.com/jakevdp/PythonDataScienceHandbook) ⭐ 49,777 | 🐛 227 | 🌐 Jupyter Notebook | 📅 2024-06-26 - Jake Vanderplas, Excellent Book and accompanying tutorial notebooks.
