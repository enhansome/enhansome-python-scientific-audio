...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 506,623 | 🐛 106 | 📅 2026-09-02 [![Build Status](https://github.com/faroit/awesome-python-scientific-audio/workflows/CI/badge.svg)](https://github.com/faroit/awesome-python-scientific-audio/actions?query=workflow%3ACI+branch%3Amaster+event%3Apush) ⭐ 1,712 | 🐛 34 | 📅 2026-09-11
...
* [pyAV](http://docs.mikeboers.com/pyav/) [:octocat:](https://github.com/mikeboers/PyAV) ⭐ 3,284 | 🐛 6 | 🌐 Python | 📅 2026-09-16 - PyAV is a Pythonic binding for FFmpeg or Libav.
* [mutagen](https://mutagen.readthedocs.io/) [:octocat:](https://github.com/quodlibet/mutagen) ⭐ 1,957 | 🐛 122 | 🌐 Python | 📅 2026-08-20 [:package:](https://pypi.python.org/pypi/mutagen) - Reads and writes all kind of audio metadata for various formats.
* [tinytag](https://github.com/devsnd/tinytag) ⭐ 840 | 🐛 5 | 🌐 Python | 📅 2026-09-15 [:octocat:](https://github.com/devsnd/tinytag) ⭐ 840 | 🐛 5 | 🌐 Python | 📅 2026-09-15 [:package:](https://pypi.python.org/pypi/tinytag/) - reading music meta data of MP3, OGG, FLAC and Wave files.
...
* [pyroomacoustics](https://github.com/LCAV/pyroomacoustics) ⭐ 1,940 | 🐛 22 | 🌐 Python | 📅 2026-07-17 [:octocat:](https://github.com/LCAV/pyroomacoustics) ⭐ 1,940 | 🐛 22 | 🌐 Python | 📅 2026-07-17 [:package:](https://pypi.python.org/pypi/pyroomacoustics) - Room Acoustics Simulation (RIR generator)
...
* [phonometry](https://jmrplens.github.io/phonometry/) [:octocat:](https://github.com/jmrplens/phonometry) ⭐ 116 | 🐛 7 | 🌐 Python | 📅 2026-09-16 [:package:](https://pypi.org/project/phonometry/) - Standard-conformant acoustic measurement (formerly PyOctaveBand): fractional-octave filtering, sound level metrology, psychoacoustics, building and underwater acoustics, each metric checked against its governing standard.
...
* [pyannote.audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,557 | 🐛 39 | 🌐 Jupyter Notebook | 📅 2026-09-15 [:octocat:](https://github.com/pyannote/pyannote-audio) ⭐ 10,557 | 🐛 39 | 🌐 Jupyter Notebook | 📅 2026-09-15 [:package:](https://pypi.org/project/pyannote-audio/) - Neural building blocks for speaker diarization.
...
* [Montreal Forced Aligner](https://montrealcorpustools.github.io/Montreal-Forced-Aligner/) [:octocat:](https://github.com/MontrealCorpusTools/Montreal-Forced-Aligner) ⭐ 1,887 | 🐛 287 | 🌐 Python | 📅 2026-08-20 - Forced aligner, based on Kaldi (HMM), English (others can be trained).
...
* [visqol-python](https://github.com/talker93/visqol-python) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-09-16 [:octocat:](https://github.com/talker93/visqol-python) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-09-16 [:package:](https://pypi.org/project/visqol-python/) - Port of Google's ViSQOL audio/speech quality metric (MOS-LQO) that installs without Bazel.
...
* [Brian2](http://briansimulator.org/) [:octocat:](https://github.com/brian-team/brian2) ⭐ 1,230 | 🐛 208 | 🌐 Python | 📅 2026-09-14 [:package:](https://pypi.python.org/pypi/Brian2) - Spiking neural networks simulator, includes cochlea model.
...
* [librosa](http://librosa.github.io/librosa/) [:octocat:](https://github.com/librosa/librosa) ⭐ 8,614 | 🐛 51 | 🌐 Python | 📅 2026-09-15 [:package:](https://pypi.python.org/pypi/librosa) - General audio and music analysis.
...
* [mir\_eval](http://craffel.github.io/mir_eval/) [:octocat:](https://github.com/craffel/mir_eval) ⭐ 713 | 🐛 37 | 🌐 Python | 📅 2026-02-19 [:package:](https://pypi.python.org/pypi/mir_eval) - Common scores for various MIR tasks. Also includes bss\_eval implementation.
* [msaf](http://pythonhosted.org/msaf/) [:octocat:](https://github.com/urinieto/msaf) ⭐ 559 | 🐛 21 | 🌐 Python | 📅 2026-05-13 [:package:](https://pypi.python.org/pypi/msaf) - Music Structure Analysis Framework.
...
* [TorchAudio](https://github.com/pytorch/audio) ⭐ 2,939 | 🐛 339 | 🌐 Python | 📅 2026-09-16 [:octocat:](https://github.com/pytorch/audio) ⭐ 2,939 | 🐛 339 | 🌐 Python | 📅 2026-09-16 - PyTorch Audio Loaders
...
* [Music21](http://web.mit.edu/music21/) [:octocat:](https://github.com/cuthbertLab/music21) ⭐ 2,584 | 🐛 153 | 🌐 Python | 📅 2026-09-14 [:package:](https://pypi.python.org/pypi/music21) - Toolkit for Computer-Aided Musicology.
* [Mido](https://mido.readthedocs.io/en/latest/) [:octocat:](https://github.com/olemb/mido) ⭐ 1,639 | 🐛 122 | 🌐 Python | 📅 2026-06-27 [:package:](https://pypi.python.org/pypi/mido) - Realtime MIDI wrapper.
...
* [python-sounddevice](https://github.com/spatialaudio/python-sounddevice) ⭐ 1,272 | 🐛 204 | 🌐 Python | 📅 2026-08-29 [:octocat:](http://python-sounddevice.readthedocs.io) [:package:](https://pypi.python.org/pypi/sounddevice) - PortAudio wrapper providing realtime audio I/O with NumPy.
* [Jupylet](https://github.com/nir/jupylet) ⭐ 252 | 🐛 10 | 🌐 Python | 📅 2026-09-16 [:octocat:](https://github.com/nir/jupylet) ⭐ 252 | 🐛 10 | 🌐 Python | 📅 2026-09-16 - Subtractive, additive, FM, and sample-based sound synthesis.
...
* [Youtube-Downloader](http://rg3.github.io/youtube-dl/) [:octocat:](https://github.com/rg3/youtube-dl) ⭐ 141,246 | 🐛 4,125 | 🌐 Python | 📅 2026-02-19 [:package:](https://pypi.python.org/pypi/youtube_dl) - Download youtube videos (and the audio).
* [beets](http://beets.io/) [:octocat:](https://github.com/beetbox/beets) ⭐ 15,668 | 🐛 714 | 🌐 Python | 📅 2026-09-16 [:package:](https://pypi.python.org/pypi/beets) - Music library manager and [MusicBrainz](https://musicbrainz.org/) tagger.
...
* [Introduction to Numpy and Scipy](http://www.scipy-lectures.org/index.html) [:octocat:](https://github.com/scipy-lectures/scipy-lecture-notes) ⭐ 3,218 | 🐛 31 | 🌐 Python | 📅 2026-09-15 - Highly recommended tutorial, covers large parts of the scientific Python ecosystem.
...
* [Python Data Science Handbook](https://github.com/jakevdp/PythonDataScienceHandbook) ⭐ 49,897 | 🐛 227 | 🌐 Jupyter Notebook | 📅 2024-06-26 - Jake Vanderplas, Excellent Book and accompanying tutorial notebooks.
