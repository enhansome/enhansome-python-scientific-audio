...
* [pyAV](http://docs.mikeboers.com/pyav/) [:octocat:](https://github.com/mikeboers/PyAV) ⭐ 3,266 | 🐛 5 | 🌐 Python | 📅 2026-08-18 - PyAV is a Pythonic binding for FFmpeg or Libav.
* [mutagen](https://mutagen.readthedocs.io/) [:octocat:](https://github.com/quodlibet/mutagen) ⭐ 1,948 | 🐛 121 | 🌐 Python | 📅 2026-07-13 [:package:](https://pypi.python.org/pypi/mutagen) - Reads and writes all kind of audio metadata for various formats.
* [tinytag](https://github.com/devsnd/tinytag) ⭐ 832 | 🐛 6 | 🌐 Python | 📅 2026-08-10 [:octocat:](https://github.com/devsnd/tinytag) ⭐ 832 | 🐛 6 | 🌐 Python | 📅 2026-08-10 [:package:](https://pypi.python.org/pypi/tinytag/) - reading music meta data of MP3, OGG, FLAC and Wave files.
...
* [pydub](http://pydub.com) [:octocat:](https://github.com/jiaaro/pydub) ⭐ 9,791 | 🐛 421 | 🌐 Python | 📅 2026-03-19 [:package:](https://pypi.python.org/pypi/mdct) - Manipulate audio with a simple and easy high level interface.
* [matchering](https://github.com/sergree/matchering) ⭐ 2,608 | 🐛 34 | 🌐 Python | 📅 2026-07-08 [:octocat:](https://github.com/sergree/matchering) ⭐ 2,608 | 🐛 34 | 🌐 Python | 📅 2026-07-08 [:package:](https://pypi.org/project/matchering/) - Automated reference audio mastering.
...
* [aubio](http://aubio.org/) [:octocat:](https://github.com/aubio/aubio) ⭐ 3,749 | 🐛 157 | 🌐 C | 📅 2026-04-10 [:package:](https://pypi.python.org/pypi/aubio) - Feature extractor, written in C, Python interface.
...
* [audiomentations](https://github.com/iver56/audiomentations) ⭐ 2,312 | 🐛 59 | 🌐 Python | 📅 2026-04-13 [:octocat:](https://github.com/iver56/audiomentations) ⭐ 2,312 | 🐛 59 | 🌐 Python | 📅 2026-04-13 [:package:](https://pypi.org/project/audiomentations/) -  Audio Data Augmentation.
...
* [pyannote.audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,431 | 🐛 34 | 🌐 Jupyter Notebook | 📅 2026-08-04 [:octocat:](https://github.com/pyannote/pyannote-audio) ⭐ 10,431 | 🐛 34 | 🌐 Jupyter Notebook | 📅 2026-08-04 [:package:](https://pypi.org/project/pyannote-audio/) - Neural building blocks for speaker diarization.
...
* [Montreal Forced Aligner](https://montrealcorpustools.github.io/Montreal-Forced-Aligner/) [:octocat:](https://github.com/MontrealCorpusTools/Montreal-Forced-Aligner) ⭐ 1,869 | 🐛 292 | 🌐 Python | 📅 2026-08-07 - Forced aligner, based on Kaldi (HMM), English (others can be trained).
...
* [Brian2](http://briansimulator.org/) [:octocat:](https://github.com/brian-team/brian2) ⭐ 1,217 | 🐛 205 | 🌐 Python | 📅 2026-08-01 [:package:](https://pypi.python.org/pypi/Brian2) - Spiking neural networks simulator, includes cochlea model.
...
* [librosa](http://librosa.github.io/librosa/) [:octocat:](https://github.com/librosa/librosa) ⭐ 8,564 | 🐛 45 | 🌐 Python | 📅 2026-08-17 [:package:](https://pypi.python.org/pypi/librosa) - General audio and music analysis.
* [Madmom](https://madmom.readthedocs.io/en/latest/) [:octocat:](https://github.com/CPJKU/madmom) ⭐ 1,696 | 🐛 81 | 🌐 Python | 📅 2026-03-20 [:package:](https://pypi.python.org/pypi/madmom) - MIR packages with strong focus on beat detection, onset detection and chord recognition.
...
* [TorchAudio](https://github.com/pytorch/audio) ⭐ 2,925 | 🐛 337 | 🌐 Python | 📅 2026-08-18 [:octocat:](https://github.com/pytorch/audio) ⭐ 2,925 | 🐛 337 | 🌐 Python | 📅 2026-08-18 - PyTorch Audio Loaders
...
* [Music21](http://web.mit.edu/music21/) [:octocat:](https://github.com/cuthbertLab/music21) ⭐ 2,566 | 🐛 155 | 🌐 Python | 📅 2026-08-12 [:package:](https://pypi.python.org/pypi/music21) - Toolkit for Computer-Aided Musicology.
* [Mido](https://mido.readthedocs.io/en/latest/) [:octocat:](https://github.com/olemb/mido) ⭐ 1,635 | 🐛 120 | 🌐 Python | 📅 2026-06-27 [:package:](https://pypi.python.org/pypi/mido) - Realtime MIDI wrapper.
...
* [Youtube-Downloader](http://rg3.github.io/youtube-dl/) [:octocat:](https://github.com/rg3/youtube-dl) ⭐ 140,968 | 🐛 4,129 | 🌐 Python | 📅 2026-02-19 [:package:](https://pypi.python.org/pypi/youtube_dl) - Download youtube videos (and the audio).
* [beets](http://beets.io/) [:octocat:](https://github.com/beetbox/beets) ⭐ 15,555 | 🐛 712 | 🌐 Python | 📅 2026-08-18 [:package:](https://pypi.python.org/pypi/beets) - Music library manager and [MusicBrainz](https://musicbrainz.org/) tagger.
...
* [Introduction to Numpy and Scipy](http://www.scipy-lectures.org/index.html) [:octocat:](https://github.com/scipy-lectures/scipy-lecture-notes) ⭐ 3,216 | 🐛 32 | 🌐 Python | 📅 2026-05-01 - Highly recommended tutorial, covers large parts of the scientific Python ecosystem.
...
* [Python Data Science Handbook](https://github.com/jakevdp/PythonDataScienceHandbook) ⭐ 49,630 | 🐛 227 | 🌐 Jupyter Notebook | 📅 2024-06-26 - Jake Vanderplas, Excellent Book and accompanying tutorial notebooks.
