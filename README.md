...
* [pyAV](http://docs.mikeboers.com/pyav/) [:octocat:](https://github.com/mikeboers/PyAV) ⭐ 3,290 | 🐛 6 | 🌐 Python | 📅 2026-09-23 - PyAV is a Pythonic binding for FFmpeg or Libav.
...
* [pySox](https://github.com/rabitt/pysox) ⭐ 542 | 🐛 35 | 🌐 Python | 📅 2025-03-26 [:octocat:](https://github.com/rabitt/pysox) ⭐ 542 | 🐛 35 | 🌐 Python | 📅 2025-03-26 [:package:](https://pypi.python.org/pypi/pysox/) - Wrapper for sox.
...
* [pyfar](https://pyfar.readthedocs.io) [:octocat:](https://github.com/pyfar/pyfar) ⭐ 137 | 🐛 87 | 🌐 Python | 📅 2026-09-25 [:package:](https://pypi.org/project/pyfar/) - Read audio files, SOFA files, and COMSOL data with the [pyfar.io](https://pyfar.readthedocs.io/en/stable/modules/pyfar.io.html) module.
...
* [matchering](https://github.com/sergree/matchering) ⭐ 2,646 | 🐛 34 | 🌐 Python | 📅 2026-07-08 [:octocat:](https://github.com/sergree/matchering) ⭐ 2,646 | 🐛 34 | 🌐 Python | 📅 2026-07-08 [:package:](https://pypi.org/project/matchering/) - Automated reference audio mastering.
...
* [pyfar](https://pyfar.readthedocs.io) [:octocat:](https://github.com/pyfar/pyfar) ⭐ 137 | 🐛 87 | 🌐 Python | 📅 2026-09-25 [:package:](https://pypi.org/project/pyfar/) - Perform general DSP and filtering tailored for acoustic signals with the [pyfar.dsp](https://pyfar.readthedocs.io/en/stable/modules/pyfar.dsp.html) module.
* [phonometry](https://jmrplens.github.io/phonometry/) [:octocat:](https://github.com/jmrplens/phonometry) ⭐ 118 | 🐛 0 | 🌐 Python | 📅 2026-09-25 [:package:](https://pypi.org/project/phonometry/) - Standard-conformant acoustic measurement (formerly PyOctaveBand): fractional-octave filtering, sound level metrology, psychoacoustics, building and underwater acoustics, each metric checked against its governing standard.
...
* [aubio](http://aubio.org/) [:octocat:](https://github.com/aubio/aubio) ⭐ 3,759 | 🐛 160 | 🌐 C | 📅 2026-04-10 [:package:](https://pypi.python.org/pypi/aubio) - Feature extractor, written in C, Python interface.
* [essentia](http://essentia.upf.edu) [:octocat:](https://github.com/MTG/essentia) ⭐ 3,742 | 🐛 440 | 🌐 C++ | 📅 2026-09-21 - Music related low level and high level feature extractor, C++ based, includes Python bindings.
* [audioFlux](https://github.com/libAudioFlux/audioFlux) ⭐ 3,367 | 🐛 16 | 🌐 C | 📅 2026-03-06 [:octocat:](https://github.com/libAudioFlux/audioFlux) ⭐ 3,367 | 🐛 16 | 🌐 C | 📅 2026-03-06 [:package:](https://pypi.python.org/pypi/audioflux) - A library for audio and music analysis, feature extraction.
...
* [pyannote.audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,593 | 🐛 42 | 🌐 Jupyter Notebook | 📅 2026-09-24 [:octocat:](https://github.com/pyannote/pyannote-audio) ⭐ 10,593 | 🐛 42 | 🌐 Jupyter Notebook | 📅 2026-09-24 [:package:](https://pypi.org/project/pyannote-audio/) - Neural building blocks for speaker diarization.
...
* [pyAudioAnalysis](https://github.com/tyiannak/pyAudioAnalysis) ⭐ 6,264 | 🐛 205 | 🌐 Python | 📅 2025-08-04² [:octocat:](https://github.com/tyiannak/pyAudioAnalysis) ⭐ 6,264 | 🐛 205 | 🌐 Python | 📅 2025-08-04 [:package:](https://pypi.python.org/pypi/pyAudioAnalysis/) - Feature Extraction, Classification, Diarization.
...
* [Brian2](http://briansimulator.org/) [:octocat:](https://github.com/brian-team/brian2) ⭐ 1,237 | 🐛 208 | 🌐 Python | 📅 2026-09-21 [:package:](https://pypi.python.org/pypi/Brian2) - Spiking neural networks simulator, includes cochlea model.
...
* [librosa](http://librosa.github.io/librosa/) [:octocat:](https://github.com/librosa/librosa) ⭐ 8,630 | 🐛 51 | 🌐 Python | 📅 2026-09-24 [:package:](https://pypi.python.org/pypi/librosa) - General audio and music analysis.
...
* [TorchAudio](https://github.com/pytorch/audio) ⭐ 2,945 | 🐛 340 | 🌐 Python | 📅 2026-09-25 [:octocat:](https://github.com/pytorch/audio) ⭐ 2,945 | 🐛 340 | 🌐 Python | 📅 2026-09-25 - PyTorch Audio Loaders
...
* [Music21](http://web.mit.edu/music21/) [:octocat:](https://github.com/cuthbertLab/music21) ⭐ 2,588 | 🐛 157 | 🌐 Python | 📅 2026-09-24 [:package:](https://pypi.python.org/pypi/music21) - Toolkit for Computer-Aided Musicology.
...
* [PYO](http://ajaxsoundstudio.com/software/pyo/) [:octocat:](https://github.com/belangeo/pyo) ⭐ 1,453 | 🐛 33 | 🌐 Python | 📅 2026-07-20 - Realtime audio dsp engine.
* [python-sounddevice](https://github.com/spatialaudio/python-sounddevice) ⭐ 1,274 | 🐛 204 | 🌐 Python | 📅 2026-08-29 [:octocat:](http://python-sounddevice.readthedocs.io) [:package:](https://pypi.python.org/pypi/sounddevice) - PortAudio wrapper providing realtime audio I/O with NumPy.
...
* [Youtube-Downloader](http://rg3.github.io/youtube-dl/) [:octocat:](https://github.com/rg3/youtube-dl) ⭐ 141,354 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 [:package:](https://pypi.python.org/pypi/youtube_dl) - Download youtube videos (and the audio).
* [beets](http://beets.io/) [:octocat:](https://github.com/beetbox/beets) ⭐ 15,711 | 🐛 709 | 🌐 Python | 📅 2026-09-25 [:package:](https://pypi.python.org/pypi/beets) - Music library manager and [MusicBrainz](https://musicbrainz.org/) tagger.
...
* [Python Data Science Handbook](https://github.com/jakevdp/PythonDataScienceHandbook) ⭐ 49,994 | 🐛 226 | 🌐 Jupyter Notebook | 📅 2024-06-26 - Jake Vanderplas, Excellent Book and accompanying tutorial notebooks.
