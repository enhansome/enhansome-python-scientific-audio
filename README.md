...
* [pyAV](http://docs.mikeboers.com/pyav/) [:octocat:](https://github.com/mikeboers/PyAV) ⭐ 3,282 | 🐛 7 | 🌐 Python | 📅 2026-09-02 - PyAV is a Pythonic binding for FFmpeg or Libav.
...
* [tinytag](https://github.com/devsnd/tinytag) ⭐ 840 | 🐛 6 | 🌐 Python | 📅 2026-09-07 [:octocat:](https://github.com/devsnd/tinytag) ⭐ 840 | 🐛 6 | 🌐 Python | 📅 2026-09-07 [:package:](https://pypi.python.org/pypi/tinytag/) - reading music meta data of MP3, OGG, FLAC and Wave files.
...
* [matchering](https://github.com/sergree/matchering) ⭐ 2,633 | 🐛 34 | 🌐 Python | 📅 2026-07-08 [:octocat:](https://github.com/sergree/matchering) ⭐ 2,633 | 🐛 34 | 🌐 Python | 📅 2026-07-08 [:package:](https://pypi.org/project/matchering/) - Automated reference audio mastering.
...
* [phonometry](https://jmrplens.github.io/phonometry/) [:octocat:](https://github.com/jmrplens/phonometry) ⭐ 115 | 🐛 3 | 🌐 Python | 📅 2026-09-14 [:package:](https://pypi.org/project/phonometry/) - Standard-conformant acoustic measurement (formerly PyOctaveBand): fractional-octave filtering, sound level metrology, psychoacoustics, building and underwater acoustics, each metric checked against its governing standard.
...
* [aubio](http://aubio.org/) [:octocat:](https://github.com/aubio/aubio) ⭐ 3,757 | 🐛 159 | 🌐 C | 📅 2026-04-10 [:package:](https://pypi.python.org/pypi/aubio) - Feature extractor, written in C, Python interface.
* [essentia](http://essentia.upf.edu) [:octocat:](https://github.com/MTG/essentia) ⭐ 3,722 | 🐛 438 | 🌐 C++ | 📅 2026-08-27 - Music related low level and high level feature extractor, C++ based, includes Python bindings.
...
* [pyannote.audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,548 | 🐛 39 | 🌐 Jupyter Notebook | 📅 2026-09-10 [:octocat:](https://github.com/pyannote/pyannote-audio) ⭐ 10,548 | 🐛 39 | 🌐 Jupyter Notebook | 📅 2026-09-10 [:package:](https://pypi.org/project/pyannote-audio/) - Neural building blocks for speaker diarization.
...
* [Montreal Forced Aligner](https://montrealcorpustools.github.io/Montreal-Forced-Aligner/) [:octocat:](https://github.com/MontrealCorpusTools/Montreal-Forced-Aligner) ⭐ 1,884 | 🐛 287 | 🌐 Python | 📅 2026-08-20 - Forced aligner, based on Kaldi (HMM), English (others can be trained).
...
* [librosa](http://librosa.github.io/librosa/) [:octocat:](https://github.com/librosa/librosa) ⭐ 8,608 | 🐛 52 | 🌐 Python | 📅 2026-08-22 [:package:](https://pypi.python.org/pypi/librosa) - General audio and music analysis.
* [Madmom](https://madmom.readthedocs.io/en/latest/) [:octocat:](https://github.com/CPJKU/madmom) ⭐ 1,709 | 🐛 81 | 🌐 Python | 📅 2026-03-20 [:package:](https://pypi.python.org/pypi/madmom) - MIR packages with strong focus on beat detection, onset detection and chord recognition.
...
* [TorchAudio](https://github.com/pytorch/audio) ⭐ 2,938 | 🐛 339 | 🌐 Python | 📅 2026-09-14 [:octocat:](https://github.com/pytorch/audio) ⭐ 2,938 | 🐛 339 | 🌐 Python | 📅 2026-09-14 - PyTorch Audio Loaders
...
* [Music21](http://web.mit.edu/music21/) [:octocat:](https://github.com/cuthbertLab/music21) ⭐ 2,583 | 🐛 153 | 🌐 Python | 📅 2026-09-11 [:package:](https://pypi.python.org/pypi/music21) - Toolkit for Computer-Aided Musicology.
...
* [PYO](http://ajaxsoundstudio.com/software/pyo/) [:octocat:](https://github.com/belangeo/pyo) ⭐ 1,450 | 🐛 33 | 🌐 Python | 📅 2026-07-20 - Realtime audio dsp engine.
...
* [Jupylet](https://github.com/nir/jupylet) ⭐ 252 | 🐛 10 | 🌐 Python | 📅 2026-09-14 [:octocat:](https://github.com/nir/jupylet) ⭐ 252 | 🐛 10 | 🌐 Python | 📅 2026-09-14 - Subtractive, additive, FM, and sample-based sound synthesis.
...
* [Youtube-Downloader](http://rg3.github.io/youtube-dl/) [:octocat:](https://github.com/rg3/youtube-dl) ⭐ 141,219 | 🐛 4,125 | 🌐 Python | 📅 2026-02-19 [:package:](https://pypi.python.org/pypi/youtube_dl) - Download youtube videos (and the audio).
* [beets](http://beets.io/) [:octocat:](https://github.com/beetbox/beets) ⭐ 15,660 | 🐛 710 | 🌐 Python | 📅 2026-09-13 [:package:](https://pypi.python.org/pypi/beets) - Music library manager and [MusicBrainz](https://musicbrainz.org/) tagger.
...
* [Python Data Science Handbook](https://github.com/jakevdp/PythonDataScienceHandbook) ⭐ 49,869 | 🐛 227 | 🌐 Jupyter Notebook | 📅 2024-06-26 - Jake Vanderplas, Excellent Book and accompanying tutorial notebooks.
