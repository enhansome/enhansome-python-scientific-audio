...
* [pyAV](http://docs.mikeboers.com/pyav/) [:octocat:](https://github.com/mikeboers/PyAV) ⭐ 3,266 | 🐛 4 | 🌐 Python | 📅 2026-08-15 - PyAV is a Pythonic binding for FFmpeg or Libav.
...
* [pyfar](https://pyfar.readthedocs.io) [:octocat:](https://github.com/pyfar/pyfar) ⭐ 135 | 🐛 83 | 🌐 Python | 📅 2026-08-14 [:package:](https://pypi.org/project/pyfar/) - Read audio files, SOFA files, and COMSOL data with the [pyfar.io](https://pyfar.readthedocs.io/en/stable/modules/pyfar.io.html) module.
...
* [PyWavelets](http://pywavelets.readthedocs.io) [:octocat:](https://github.com/PyWavelets/pywt) ⭐ 2,397 | 🐛 84 | 🌐 Python | 📅 2026-08-13 [:package:](https://pypi.python.org/pypi/PyWavelets) - Discrete Wavelet Transform in Python.
* [pyroomacoustics](https://github.com/LCAV/pyroomacoustics) ⭐ 1,926 | 🐛 20 | 🌐 Python | 📅 2026-07-17 [:octocat:](https://github.com/LCAV/pyroomacoustics) ⭐ 1,926 | 🐛 20 | 🌐 Python | 📅 2026-07-17 [:package:](https://pypi.python.org/pypi/pyroomacoustics) - Room Acoustics Simulation (RIR generator)
...
* [pyfar](https://pyfar.readthedocs.io) [:octocat:](https://github.com/pyfar/pyfar) ⭐ 135 | 🐛 83 | 🌐 Python | 📅 2026-08-14 [:package:](https://pypi.org/project/pyfar/) - Perform general DSP and filtering tailored for acoustic signals with the [pyfar.dsp](https://pyfar.readthedocs.io/en/stable/modules/pyfar.dsp.html) module.
...
* [aubio](http://aubio.org/) [:octocat:](https://github.com/aubio/aubio) ⭐ 3,746 | 🐛 157 | 🌐 C | 📅 2026-04-10 [:package:](https://pypi.python.org/pypi/aubio) - Feature extractor, written in C, Python interface.
* [essentia](http://essentia.upf.edu) [:octocat:](https://github.com/MTG/essentia) ⭐ 3,693 | 🐛 425 | 🌐 C++ | 📅 2026-07-22 - Music related low level and high level feature extractor, C++ based, includes Python bindings.
...
* [audiomentations](https://github.com/iver56/audiomentations) ⭐ 2,310 | 🐛 59 | 🌐 Python | 📅 2026-04-13 [:octocat:](https://github.com/iver56/audiomentations) ⭐ 2,310 | 🐛 59 | 🌐 Python | 📅 2026-04-13 [:package:](https://pypi.org/project/audiomentations/) -  Audio Data Augmentation.
...
* [pyannote.audio](https://github.com/pyannote/pyannote-audio) ⭐ 10,424 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2026-08-04 [:octocat:](https://github.com/pyannote/pyannote-audio) ⭐ 10,424 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2026-08-04 [:package:](https://pypi.org/project/pyannote-audio/) - Neural building blocks for speaker diarization.
...
* [Montreal Forced Aligner](https://montrealcorpustools.github.io/Montreal-Forced-Aligner/) [:octocat:](https://github.com/MontrealCorpusTools/Montreal-Forced-Aligner) ⭐ 1,868 | 🐛 292 | 🌐 Python | 📅 2026-08-07 - Forced aligner, based on Kaldi (HMM), English (others can be trained).
...
* [Brian2](http://briansimulator.org/) [:octocat:](https://github.com/brian-team/brian2) ⭐ 1,216 | 🐛 205 | 🌐 Python | 📅 2026-08-01 [:package:](https://pypi.python.org/pypi/Brian2) - Spiking neural networks simulator, includes cochlea model.
...
* [librosa](http://librosa.github.io/librosa/) [:octocat:](https://github.com/librosa/librosa) ⭐ 8,559 | 🐛 47 | 🌐 Python | 📅 2026-08-11 [:package:](https://pypi.python.org/pypi/librosa) - General audio and music analysis.
...
* [TorchAudio](https://github.com/pytorch/audio) ⭐ 2,925 | 🐛 337 | 🌐 Python | 📅 2026-08-16 [:octocat:](https://github.com/pytorch/audio) ⭐ 2,925 | 🐛 337 | 🌐 Python | 📅 2026-08-16 - PyTorch Audio Loaders
...
* [Music21](http://web.mit.edu/music21/) [:octocat:](https://github.com/cuthbertLab/music21) ⭐ 2,561 | 🐛 155 | 🌐 Python | 📅 2026-08-12 [:package:](https://pypi.python.org/pypi/music21) - Toolkit for Computer-Aided Musicology.
* [Mido](https://mido.readthedocs.io/en/latest/) [:octocat:](https://github.com/olemb/mido) ⭐ 1,633 | 🐛 120 | 🌐 Python | 📅 2026-06-27 [:package:](https://pypi.python.org/pypi/mido) - Realtime MIDI wrapper.
...
* [python-sounddevice](https://github.com/spatialaudio/python-sounddevice) ⭐ 1,266 | 🐛 205 | 🌐 Python | 📅 2026-07-24 [:octocat:](http://python-sounddevice.readthedocs.io) [:package:](https://pypi.python.org/pypi/sounddevice) - PortAudio wrapper providing realtime audio I/O with NumPy.
...
* [Youtube-Downloader](http://rg3.github.io/youtube-dl/) [:octocat:](https://github.com/rg3/youtube-dl) ⭐ 140,959 | 🐛 4,129 | 🌐 Python | 📅 2026-02-19 [:package:](https://pypi.python.org/pypi/youtube_dl) - Download youtube videos (and the audio).
* [beets](http://beets.io/) [:octocat:](https://github.com/beetbox/beets) ⭐ 15,545 | 🐛 707 | 🌐 Python | 📅 2026-08-16 [:package:](https://pypi.python.org/pypi/beets) - Music library manager and [MusicBrainz](https://musicbrainz.org/) tagger.
...
* [Python Data Science Handbook](https://github.com/jakevdp/PythonDataScienceHandbook) ⭐ 49,615 | 🐛 227 | 🌐 Jupyter Notebook | 📅 2024-06-26 - Jake Vanderplas, Excellent Book and accompanying tutorial notebooks.
