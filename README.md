...
* [Brian2](http://briansimulator.org/) [:octocat:](https://github.com/brian-team/brian2) ⭐ 1,234 | 🐛 207 | 🌐 Python | 📅 2026-09-21 [:package:](https://pypi.python.org/pypi/Brian2) - Spiking neural networks simulator, includes cochlea model.
...
* [Jupylet](https://github.com/nir/jupylet) ⭐ 252 | 🐛 10 | 🌐 Python | 📅 2026-09-21 [:octocat:](https://github.com/nir/jupylet) ⭐ 252 | 🐛 10 | 🌐 Python | 📅 2026-09-21 - Subtractive, additive, FM, and sample-based sound synthesis.
...
* [Whirlwind Tour Of Python](https://jakevdp.github.io/WhirlwindTourOfPython/) [:octocat:](https://github.com/jakevdp/WhirlwindTourOfPython) ⭐ 4,041 | 🐛 25 | 🌐 Jupyter Notebook | 📅 2024-01-31 - fast-paced introduction to Python essentials, aimed at researchers and developers.
